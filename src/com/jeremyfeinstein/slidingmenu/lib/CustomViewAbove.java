...
public class CustomViewAbove extends ViewGroup {
    ...
    public void setTouchCallback(final TouchCallback callback) {
        ...
        if (isMenuOpen()) {
            ...
            switch (mTouchMode) {
                ...
                case SlidingMenu.TOUCHMODE_MARGIN:
                    boolean marginAllowed = mViewBehind.marginTouchAllowed(mContent, x);
                    if (!marginAllowed) {
                        if (!isMenuOpen() && mTouchCallback != null) {
                            return mTouchCallback.isTouchAllowedBeforeTouchMove();
                        } else {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        Log.d("TEST", "intercept result:  " + String.valueOf(mIsBeingDragged || mQuickReturn));
    ...
    private void determineDrag(MotionEvent ev) {
        ...
        if (!isMenuOpen() && mTouchCallback != null && !mTouchCallback.isTouchAllowedWithMotionDelta(mContent, dx)) {
            mIsUnableToDrag = true;
            return;
        }
